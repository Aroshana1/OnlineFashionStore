      ...
      if ($orderresult->num_rows> 0)
          {
              ...
              <table>
                  ...
                  <td>
                  <div id="edit-btn">
                      <a id="feedback-link" href="addfeedback.php?productid=<?php echo $orders['ProductID']."&userid=".$orders['UserID']?>">
                        ...
                        <script>
                          window.addEventListener('DOMContentLoaded', function() {
                            ...
                            var feedbackBtn = document.getElementById("edit-btn");
                      ...
                      <div id="delete-btn">
                      <a id="cancel-link" href="cancelorder.php?orderid=<?php echo $orders['OrderID']."&userid=".$orders['UserID']?>">
                        <button id="delete-btn" onclick = "stt()">Cancel Order</button>
                      </a>
                    </div>
                    ...
                    <script>
                      window.addEventListener('DOMContentLoaded', function(){
                        ...
                        var cancelBtn = document.getElementById("delete-btn");
