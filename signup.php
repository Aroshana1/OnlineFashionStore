...
if(isset($_GET["error"])){
	if($_GET["error"]=="emptyinput"){
		...
		echo'<div class = "error">Re enter Pasword Not match </div>';

	}elseif($_GET["error"]=="emailtaken"){
		echo'<div class = "error">The Email you entered already exists </div>';

	}elseif($_GET["error"]=="stmtfailed"){
		echo'<div class = "error">Sign Up Failed Try Again </div>';
