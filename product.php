...
<div class="content">
    <div class="container">
        ...
        <?php
        if($products["Availability"]=="InStock"){
        ...
        <hr>				
        <!--send details of product via get method url-->
            ...
            <input type="submit" id="submit-btn" value="Add to Cart" onclick="disableButton()">
            <p id = "status" style = "color:red;"></p>
            <?php 
            if($products["Availability"]!="InStock"){
            ?>
            <!--check button clickable according to product availability-->
             <script>
